...
The Hamming Code is used to correct errors, so-called bit flips, in data transmissions. Later in the description follows a detailed 
...
export function encode(text: string): string {
  ...
  for (const ch of text) {
    const binary = ch.charCodeAt(0).toString(2).padStart(8, "0");
