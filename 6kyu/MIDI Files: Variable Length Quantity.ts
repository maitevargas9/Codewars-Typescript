...
Because these timestamps are relative to one another, most values tend to be fairly small. In order to save space, MIDI 
files use a special integer encoding format called a Variable Length Quantity (VLQ).
